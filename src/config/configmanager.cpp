...
bool ConfigManager::load() {
	...
	if (!loaded) {
		...
		m_configBoolean[OLD_PROTOCOL] = true; // Hardcoded - always allow old protocol
		...
		loadStringConfig(L, MAP_NAME, "mapName", "wolf");
		loadStringConfig(L, MYSQL_DB, "mysqlDatabase", "wolf");
	...
	loadStringConfig(L, DATA_DIRECTORY, "dataPackDirectory", "data-wolf-global");
