...
bool LuaScriptInterface::getFieldBoolean(lua_State* L, int32_t arg, const std::string& key, bool defaultValue)
{
	lua_getfield(L, arg, key.c_str());
	if (lua_isnil(L, -1)) {
		lua_pop(L, 1);
	...
	bool result = getBoolean(L, -1, defaultValue);
	lua_pop(L, 1);
	return result;
}
...
void LuaScriptInterface::registerFunctions()
{
	...
	// MonsterType setters (for Lua monster registration)
	...
	registerMethod("MonsterType", "speed", LuaScriptInterface::luaMonsterTypeSpeed);
	...
	registerMethod("MonsterType", "attackable", LuaScriptInterface::luaMonsterTypeAttackable);
	registerMethod("MonsterType", "convinceable", LuaScriptInterface::luaMonsterTypeConvinceable);
	registerMethod("MonsterType", "summonable", LuaScriptInterface::luaMonsterTypeSummonable);
	registerMethod("MonsterType", "illusionable", LuaScriptInterface::luaMonsterTypeIllusionable);
	registerMethod("MonsterType", "hostile", LuaScriptInterface::luaMonsterTypeHostile);
	registerMethod("MonsterType", "passive", LuaScriptInterface::luaMonsterTypePassive);
	registerMethod("MonsterType", "pushable", LuaScriptInterface::luaMonsterTypePushable);
	registerMethod("MonsterType", "canPushItems", LuaScriptInterface::luaMonsterTypeCanPushItemsSetter);
	registerMethod("MonsterType", "canPushCreatures", LuaScriptInterface::luaMonsterTypeCanPushCreaturesSetter);
	registerMethod("MonsterType", "hiddenHealth", LuaScriptInterface::luaMonsterTypeHiddenHealth);
	registerMethod("MonsterType", "isRewardBoss", LuaScriptInterface::luaMonsterTypeRewardBoss);
	...
	registerMethod("MonsterType", "immunities", LuaScriptInterface::luaMonsterTypeImmunities);
	registerMethod("MonsterType", "elements", LuaScriptInterface::luaMonsterTypeElementList);
	registerMethod("MonsterType", "voices", LuaScriptInterface::luaMonsterTypeVoices);
	registerMethod("MonsterType", "loot", LuaScriptInterface::luaMonsterTypeLoot);
	registerMethod("MonsterType", "summons", LuaScriptInterface::luaMonsterTypeSummons);
	registerMethod("MonsterType", "attacks", LuaScriptInterface::luaMonsterTypeAttacks);
	registerMethod("MonsterType", "defenses", LuaScriptInterface::luaMonsterTypeDefenses);
	registerMethod("MonsterType", "events", LuaScriptInterface::luaMonsterTypeCreatureEvents);
	registerMethod("MonsterType", "register", LuaScriptInterface::luaMonsterTypeRegister);
	...
	registerMethod("NpcType", "nameDescription", LuaScriptInterface::luaNpcTypeNameDescription);
	registerMethod("NpcType", "health", LuaScriptInterface::luaNpcTypeHealth);
	registerMethod("NpcType", "maxHealth", LuaScriptInterface::luaNpcTypeMaxHealth);
	registerMethod("NpcType", "speed", LuaScriptInterface::luaNpcTypeSpeed);
	...
	registerMethod("NpcType", "walkRadius", LuaScriptInterface::luaNpcTypeWalkRadius);
	...
	registerMethod("NpcType", "script", LuaScriptInterface::luaNpcTypeScript);
	registerMethod("NpcType", "parameter", LuaScriptInterface::luaNpcTypeParameter);
	registerMethod("NpcType", "register", LuaScriptInterface::luaNpcTypeRegister);

	// NpcType Lua callbacks (each stores function reference in NpcType)
	registerMethod("NpcType", "onThink", LuaScriptInterface::luaNpcTypeOnThink);
	registerMethod("NpcType", "onAppear", LuaScriptInterface::luaNpcTypeOnAppear);
	registerMethod("NpcType", "onDisappear", LuaScriptInterface::luaNpcTypeOnDisappear);
	registerMethod("NpcType", "onMove", LuaScriptInterface::luaNpcTypeOnMove);
	registerMethod("NpcType", "onSay", LuaScriptInterface::luaNpcTypeOnSay);
	registerMethod("NpcType", "onCloseChannel", LuaScriptInterface::luaNpcTypeOnCloseChannel);
	...
	registerMethod("TalkAction", "words", LuaScriptInterface::luaTalkActionWords);
	...
	// Spell (RevScriptSys)
	registerClass("Spell", "", LuaScriptInterface::luaCreateSpell);
	...
	registerMethod("Spell", "secondaryGroup", LuaScriptInterface::luaSpellSecondaryGroup);
	...
	registerMethod("Spell", "secondaryGroupCooldown", LuaScriptInterface::luaSpellSecondaryGroupCooldown);
	...
	registerMethod("Spell", "blockType", LuaScriptInterface::luaSpellBlockType);
}
...
int LuaScriptInterface::luaGameCreateMonsterType(lua_State* L)
{
	...
	MonsterType* monsterType = g_monsters.addMonsterType(name);
	if (monsterType) {
...
{
	// monsterType:nameDescription(nameDescription)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushString(L, monsterType->nameDescription);
...
{
	// monsterType:runHealth(runHealth)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.runAwayHealth);
...
{
	// monsterType:experience(experience)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.experience);
...
int LuaScriptInterface::luaMonsterTypeSpeed(lua_State* L)
{
	// monsterType:speed(speed)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.baseSpeed);
...
{
	// monsterType:race(race)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.race);
		} else if (lua_isnumber(L, 2)) {
			// Numeric race value (RACE_BLOOD, RACE_VENOM, etc.)
			monsterType->info.race = getNumber<RaceType_t>(L, 2);
			pushBoolean(L, true);
		} else {
			std::string race = getString(L, 2);
			if (strcasecmp(race.c_str(), "venom") == 0) {
				monsterType->info.race = RACE_VENOM;
			} else if (strcasecmp(race.c_str(), "blood") == 0) {
				monsterType->info.race = RACE_BLOOD;
			} else if (strcasecmp(race.c_str(), "undead") == 0) {
				monsterType->info.race = RACE_UNDEAD;
			} else if (strcasecmp(race.c_str(), "fire") == 0) {
				monsterType->info.race = RACE_FIRE;
			} else if (strcasecmp(race.c_str(), "energy") == 0) {
				monsterType->info.race = RACE_ENERGY;
			} else {
				std::cout << "[Warning - MonsterType:race] Unknown race: " << race << std::endl;
				pushBoolean(L, false);
				return 1;
			}
			pushBoolean(L, true);
...
int LuaScriptInterface::luaMonsterTypeLight(lua_State* L)
{
	...
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			...
			monsterType->info.light.level = getNumber<uint8_t>(L, 2);
			monsterType->info.light.color = getNumber<uint8_t>(L, 3);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// monsterType:targetDistance(targetDistance)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.targetDistance);
...
{
	// monsterType:staticAttackChance(staticAttackChance)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.staticAttackChance);
...
{
	// monsterType:maxSummons(maxSummons)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.maxSummons);
...
{
	// monsterType:changeTargetChance(changeTargetChance)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.changeTargetChance);
...
{
	// monsterType:changeTargetSpeed(changeTargetSpeed)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.changeTargetSpeed);
...
{
	// monsterType:yellChance(yellChance)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.yellChance);
...
{
	// monsterType:yellSpeedTicks(yellSpeedTicks)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.yellSpeedTicks);
...
int LuaScriptInterface::luaMonsterTypeAttackable(lua_State* L)
{
	// monsterType:attackable(attackable)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, monsterType->info.isAttackable);
...
int LuaScriptInterface::luaMonsterTypeConvinceable(lua_State* L)
{
	// monsterType:convinceable(convinceable)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, monsterType->info.isConvinceable);
...
int LuaScriptInterface::luaMonsterTypeSummonable(lua_State* L)
{
	// monsterType:summonable(summonable)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, monsterType->info.isSummonable);
...
int LuaScriptInterface::luaMonsterTypeIllusionable(lua_State* L)
{
	// monsterType:illusionable(illusionable)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, monsterType->info.isIllusionable);
...
int LuaScriptInterface::luaMonsterTypeHostile(lua_State* L)
{
	// monsterType:hostile(hostile)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, monsterType->info.isHostile);
...
int LuaScriptInterface::luaMonsterTypePassive(lua_State* L)
{
...
int LuaScriptInterface::luaMonsterTypePushable(lua_State* L)
{
	// monsterType:pushable(pushable)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, monsterType->info.pushable);
...
int LuaScriptInterface::luaMonsterTypeCanPushItemsSetter(lua_State* L)
{
	// monsterType:canPushItems(canPushItems)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, monsterType->info.canPushItems);
...
int LuaScriptInterface::luaMonsterTypeCanPushCreaturesSetter(lua_State* L)
{
	// monsterType:canPushCreatures(canPushCreatures)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, monsterType->info.canPushCreatures);
...
int LuaScriptInterface::luaMonsterTypeHiddenHealth(lua_State* L)
{
	// monsterType:hiddenHealth(hiddenHealth)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, monsterType->info.hiddenHealth);
...
int LuaScriptInterface::luaMonsterTypeRewardBoss(lua_State* L)
{
	// monsterType:isRewardBoss(rewardBoss)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, monsterType->info.isRewardBoss);
...
{
	// monsterType:combatImmunities(immunities)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.damageImmunities);
		} else if (isTable(L, 2)) {
			// Table with immunity names
			lua_pushnil(L);
			while (lua_next(L, 2) != 0) {
				std::string immunity = getString(L, -1);
				if (strcasecmp(immunity.c_str(), "physical") == 0) {
					monsterType->info.damageImmunities |= COMBAT_PHYSICALDAMAGE;
				} else if (strcasecmp(immunity.c_str(), "energy") == 0) {
				...
				} else if (strcasecmp(immunity.c_str(), "poison") == 0 || strcasecmp(immunity.c_str(), "earth") == 0) {
					monsterType->info.damageImmunities |= COMBAT_EARTHDAMAGE;
				} else if (strcasecmp(immunity.c_str(), "drown") == 0) {
					monsterType->info.damageImmunities |= COMBAT_DROWNDAMAGE;
				} else if (strcasecmp(immunity.c_str(), "ice") == 0) {
					monsterType->info.damageImmunities |= COMBAT_ICEDAMAGE;
				} else if (strcasecmp(immunity.c_str(), "holy") == 0) {
					monsterType->info.damageImmunities |= COMBAT_HOLYDAMAGE;
				} else if (strcasecmp(immunity.c_str(), "death") == 0) {
					monsterType->info.damageImmunities |= COMBAT_DEATHDAMAGE;
				} else if (strcasecmp(immunity.c_str(), "lifedrain") == 0) {
					monsterType->info.damageImmunities |= COMBAT_LIFEDRAIN;
				} else if (strcasecmp(immunity.c_str(), "manadrain") == 0) {
...
{
	// monsterType:conditionImmunities(immunities)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.conditionImmunities);
			...
			while (lua_next(L, 2) != 0) {
				std::string immunity = getString(L, -1);
				if (strcasecmp(immunity.c_str(), "poison") == 0) {
				...
				} else if (strcasecmp(immunity.c_str(), "invisible") == 0) {
				...
				} else if (strcasecmp(immunity.c_str(), "freezing") == 0 || strcasecmp(immunity.c_str(), "freeze") == 0) {
					monsterType->info.conditionImmunities |= CONDITION_FREEZING;
				} else if (strcasecmp(immunity.c_str(), "dazzled") == 0) {
					monsterType->info.conditionImmunities |= CONDITION_DAZZLED;
				} else if (strcasecmp(immunity.c_str(), "cursed") == 0) {
					monsterType->info.conditionImmunities |= CONDITION_CURSED;
				} else if (strcasecmp(immunity.c_str(), "bleeding") == 0) {
					monsterType->info.conditionImmunities |= CONDITION_BLEEDING;
				} else if (strcasecmp(immunity.c_str(), "outfit") == 0) {
...
int LuaScriptInterface::luaMonsterTypeImmunities(lua_State* L)
{
	// monsterType:immunities({{condition = CONDITION_FIRE, immunity = true}, ...})
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.conditionImmunities);
			...
			while (lua_next(L, 2) != 0) {
				if (lua_istable(L, -1)) {
					...
					ConditionType_t condition = getNumber<ConditionType_t>(L, -1);
					lua_pop(L, 1);
					
					lua_getfield(L, -1, "immunity");
					bool immune = getBoolean(L, -1, true);
					lua_pop(L, 1);
					
					if (immune) {
						monsterType->info.conditionImmunities |= condition;
					}
				}
				lua_pop(L, 1);
			}
...
int LuaScriptInterface::luaMonsterTypeElementList(lua_State* L)
{
	// monsterType:elements(elements)
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_createtable(L, monsterType->info.elementMap.size(), 0);
			for (const auto& element : monsterType->info.elementMap) {
				lua_pushnumber(L, element.second);
				lua_rawseti(L, -2, element.first);
			}
		} else if (isTable(L, 2)) {
			lua_pushnil(L);
			while (lua_next(L, 2) != 0) {
				if (lua_istable(L, -1)) {
					// Format: {type = COMBAT_X, percent = Y}
					lua_getfield(L, -1, "type");
					CombatType_t element = getNumber<CombatType_t>(L, -1);
					lua_pop(L, 1);
					
					lua_getfield(L, -1, "percent");
					int32_t percent = getNumber<int32_t>(L, -1);
					lua_pop(L, 1);
					
					monsterType->info.elementMap[element] = percent;
				} else {
					// Format: {COMBAT_TYPE = percent}
...
int LuaScriptInterface::luaMonsterTypeVoices(lua_State* L)
{
	// monsterType:voices({{text = "...", yell = false}, ...})
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_createtable(L, monsterType->info.voiceVector.size(), 0);
			int index = 0;
			for (const auto& voice : monsterType->info.voiceVector) {
				lua_createtable(L, 0, 2);
				setField(L, "text", voice.text);
				setField(L, "yell", voice.yellText);
				lua_rawseti(L, -2, ++index);
			}
		} else if (isTable(L, 2)) {
			lua_pushnil(L);
			while (lua_next(L, 2) != 0) {
				if (lua_istable(L, -1)) {
					...
					voice.text = getString(L, -1);
					lua_pop(L, 1);
					lua_getfield(L, -1, "yell");
					voice.yellText = getBoolean(L, -1, false);
					lua_pop(L, 1);
...
int LuaScriptInterface::luaMonsterTypeLoot(lua_State* L)
{
	// monsterType:loot({{id = 2160, chance = 100000, maxCount = 50}, ...})
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_createtable(L, monsterType->info.lootItems.size(), 0);
			int index = 0;
			for (const auto& lootBlock : monsterType->info.lootItems) {
				lua_createtable(L, 0, 3);
				setField(L, "id", lootBlock.id);
				setField(L, "chance", lootBlock.chance);
				setField(L, "maxCount", lootBlock.countmax);
				lua_rawseti(L, -2, ++index);
			}
			...
			while (lua_next(L, 2) != 0) {
				if (lua_istable(L, -1)) {
					LootBlock lootBlock;
					lua_getfield(L, -1, "id");
					lootBlock.id = getNumber<uint16_t>(L, -1);
					lua_pop(L, 1);
					if (lootBlock.id == 0) {
						// Try by name
					...
					lootBlock.chance = getNumber<uint32_t>(L, -1);
					lua_pop(L, 1);
					lua_getfield(L, -1, "maxCount");
					lootBlock.countmax = getNumber<uint32_t>(L, -1);
					lua_pop(L, 1);
					if (lootBlock.countmax == 0) {
					...
					if (lua_isnil(L, -1)) {
						...
						lootBlock.subType = getNumber<int32_t>(L, -1);
					}
					lua_pop(L, 1);
					lua_getfield(L, -1, "actionId");
					if (lua_isnil(L, -1)) {
						lootBlock.actionId = -1;
					} else {
						lootBlock.actionId = getNumber<int32_t>(L, -1);
					}
					lua_pop(L, 1);
					if (lootBlock.id != 0) {
...
int LuaScriptInterface::luaMonsterTypeSummons(lua_State* L)
{
	// monsterType:summons({{name = "...", chance = 100, interval = 2000, max = 1}, ...})
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_createtable(L, monsterType->info.summons.size(), 0);
			int index = 0;
			for (const auto& summon : monsterType->info.summons) {
				lua_createtable(L, 0, 4);
				setField(L, "name", summon.name);
				setField(L, "chance", summon.chance);
				setField(L, "interval", summon.speed);
				setField(L, "max", summon.max);
				lua_rawseti(L, -2, ++index);
			}
		} else if (isTable(L, 2)) {
			lua_pushnil(L);
			while (lua_next(L, 2) != 0) {
				if (lua_istable(L, -1)) {
					...
					lua_getfield(L, -1, "name");
					summon.name = getString(L, -1);
					lua_pop(L, 1);
					lua_getfield(L, -1, "chance");
					summon.chance = getNumber<uint32_t>(L, -1);
					lua_pop(L, 1);
					lua_getfield(L, -1, "interval");
					summon.speed = getNumber<uint32_t>(L, -1);
					lua_pop(L, 1);
					if (summon.speed == 0) {
						summon.speed = 2000;
					}
					lua_getfield(L, -1, "max");
					summon.max = getNumber<uint32_t>(L, -1);
					lua_pop(L, 1);
					if (summon.max == 0) {
						summon.max = 1;
					}
					lua_getfield(L, -1, "force");
					summon.force = getBoolean(L, -1, false);
					lua_pop(L, 1);
...
int LuaScriptInterface::luaMonsterTypeAttacks(lua_State* L)
{
	...
	while (lua_next(L, 2) != 0) {
		if (isTable(L, -1)) {
			...
			// Store original name for spell lookup
			std::string originalName = attackName;
			...
			// First, try to find a spell by name in spells.xml
			InstantSpell* spell = g_spells->getInstantSpellByName(originalName);
			if (spell) {
				// Found spell by name - use it directly
				sb.spell = spell;
				sb.combatSpell = true; // Assume aggressive for monster attacks
			...
			bool isConditionSpell = false;
			ConditionType_t conditionType = CONDITION_NONE;
			int32_t conditionDuration = 10000;
			...
			if (attackName == "melee") {
				...
				isConditionSpell = true;
				conditionType = CONDITION_PARALYZE;
				conditionDuration = 10000;
				lua_getfield(L, -1, "duration");
				if (lua_isnumber(L, -1)) {
					conditionDuration = getNumber<int32_t>(L, -1);
				}
				lua_pop(L, 1);
			} else if (attackName == "drunk") {
				// Drunk condition
				isConditionSpell = true;
				...
				lua_pop(L, 1);
			} else if (attackName == "strength") {
				// Skill reduction - use attributes condition
				isConditionSpell = true;
				conditionType = CONDITION_ATTRIBUTES;
				conditionDuration = 15000;
				lua_getfield(L, -1, "duration");
				if (lua_isnumber(L, -1)) {
					conditionDuration = getNumber<int32_t>(L, -1);
				}
				...
				// Unknown attack type - try to find as spell first, otherwise use physical
				combatType = COMBAT_PHYSICALDAMAGE;
			}

			// Handle condition-based spells
			if (isConditionSpell) {
				...
				if (lua_isnumber(L, -1)) {
					...
					combat->setParam(COMBAT_PARAM_EFFECT, CONST_ME_MAGIC_RED);
				}
				lua_pop(L, 1);

				// Create condition
				Condition* condition = Condition::createCondition(CONDITIONID_COMBAT, conditionType, conditionDuration, 0);
				if (condition) {
					if (conditionType == CONDITION_PARALYZE) {
						// Speed reduction
						int32_t speedChange = -200;
						lua_getfield(L, -1, "speedChange");
						if (lua_isnumber(L, -1)) {
							speedChange = getNumber<int32_t>(L, -1);
						}
						lua_pop(L, 1);
						condition->setParam(CONDITION_PARAM_SPEED, speedChange);
						combat->setCondition(condition);
					} else if (conditionType == CONDITION_ATTRIBUTES) {
						// Skill reduction
						condition->setParam(CONDITION_PARAM_SKILL_MELEEPERCENT, 50);
						condition->setParam(CONDITION_PARAM_SKILL_FISTPERCENT, 50);
						condition->setParam(CONDITION_PARAM_SKILL_DISTANCEPERCENT, 50);
						condition->setParam(CONDITION_PARAM_SKILL_SHIELDPERCENT, 50);
						combat->setCondition(condition);
					} else if (conditionType == CONDITION_OUTFIT) {
						// Outfit change - need ConditionOutfit for setOutfit method
						delete condition;
						ConditionOutfit* outfitCondition = new ConditionOutfit(CONDITIONID_COMBAT, CONDITION_OUTFIT, conditionDuration, false, 0);
						
						Outfit_t outfit;
						lua_getfield(L, -1, "outfitMonster");
						if (lua_isstring(L, -1)) {
							std::string monsterName = getString(L, -1);
							MonsterType* mt = g_monsters.getMonsterType(monsterName);
							if (mt) {
								outfit = mt->info.outfit;
							}
						}
						lua_pop(L, 1);
						
						lua_getfield(L, -1, "outfitItem");
						if (lua_isnumber(L, -1)) {
							outfit.lookTypeEx = getNumber<uint16_t>(L, -1);
						}
						lua_pop(L, 1);

						lua_getfield(L, -1, "outfitType");
						if (lua_isnumber(L, -1)) {
							outfit.lookType = getNumber<uint16_t>(L, -1);
						}
						lua_pop(L, 1);

						outfitCondition->setOutfit(outfit);
						combat->setCondition(outfitCondition);
					} else {
						// Other conditions (DRUNK, INVISIBLE, etc.)
						combat->setCondition(condition);
					}
				}
...
int LuaScriptInterface::luaMonsterTypeDefenses(lua_State* L)
{
	// monsterType:defenses(defenses)
	// Note: For full defense support, defenses should be defined in XML or extended later
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, monsterType->info.defenseSpells.size());
		} else {
			// For now, just acknowledge - full defense parsing needs XML integration
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaMonsterTypeCreatureEvents(lua_State* L)
{
	// monsterType:events({"event1", "event2", ...})
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (lua_gettop(L) == 1) {
			lua_createtable(L, monsterType->info.scripts.size(), 0);
			int index = 0;
			for (const auto& script : monsterType->info.scripts) {
				pushString(L, script);
				lua_rawseti(L, -2, ++index);
			}
		} else if (isTable(L, 2)) {
			lua_pushnil(L);
			while (lua_next(L, 2) != 0) {
				monsterType->info.scripts.push_back(getString(L, -1));
				lua_pop(L, 1);
			}
			pushBoolean(L, true);
		}
...
int LuaScriptInterface::luaMonsterTypeRegister(lua_State* L)
{
	// monsterType:register()
	MonsterType* monsterType = getUserdata<MonsterType>(L, 1);
	if (monsterType) {
		if (monsterType->name.empty()) {
			reportErrorFunc("MonsterType has no name");
			pushBoolean(L, false);
			return 1;
		}

		// Ensure health values are set properly
		if (monsterType->info.healthMax == 0) {
			monsterType->info.healthMax = monsterType->info.health;
		}
		if (monsterType->info.health == 0) {
			monsterType->info.health = monsterType->info.healthMax;
		}
...
int LuaScriptInterface::luaGameCreateNpcType(lua_State* L)
{
	...
	const std::string& name = getString(L, 1);
	NpcType* npcType = g_npcTypes.addNpcType(name);
	if (npcType) {
		npcType->name = name;
...
int LuaScriptInterface::luaNpcTypeCreate(lua_State* L)
{
	...
	if (!npcType) {
		npcType = g_npcTypes.addNpcType(name);
	}
	if (npcType) {
		pushUserdata<NpcType>(L, npcType);
		setMetatable(L, -1, "NpcType");
...
int LuaScriptInterface::luaNpcTypeNameDescription(lua_State* L)
{
	// npcType:nameDescription(desc)
	NpcType* npcType = getUserdata<NpcType>(L, 1);
	if (npcType) {
		if (lua_gettop(L) == 1) {
...
int LuaScriptInterface::luaNpcTypeHealth(lua_State* L)
{
	...
	if (npcType) {
		if (lua_gettop(L) == 1) {
			...
			npcType->health = getNumber<int32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// npcType:maxHealth(health)
	NpcType* npcType = getUserdata<NpcType>(L, 1);
	if (npcType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, npcType->healthMax);
		} else {
			npcType->healthMax = getNumber<int32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaNpcTypeSpeed(lua_State* L)
{
	// npcType:speed(speed)
	NpcType* npcType = getUserdata<NpcType>(L, 1);
	if (npcType) {
		if (lua_gettop(L) == 1) {
			...
			npcType->baseSpeed = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaNpcTypeOutfit(lua_State* L)
{
...
int LuaScriptInterface::luaNpcTypeWalkInterval(lua_State* L)
{
	// npcType:walkInterval(interval)
	NpcType* npcType = getUserdata<NpcType>(L, 1);
	if (npcType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, npcType->walkInterval);
		} else {
			npcType->walkInterval = getNumber<uint32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaNpcTypeWalkRadius(lua_State* L)
{
	// npcType:walkRadius(radius)
	NpcType* npcType = getUserdata<NpcType>(L, 1);
	if (npcType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, npcType->walkRadius);
		} else {
			npcType->walkRadius = getNumber<int32_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// npcType:speechBubble(speechBubble)
	NpcType* npcType = getUserdata<NpcType>(L, 1);
	if (npcType) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, npcType->speechBubble);
		} else {
			npcType->speechBubble = getNumber<uint8_t>(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaNpcTypeScript(lua_State* L)
{
	// npcType:script(scriptFile)
	NpcType* npcType = getUserdata<NpcType>(L, 1);
	if (npcType) {
		if (lua_gettop(L) == 1) {
			pushString(L, npcType->scriptFile);
		} else {
			npcType->scriptFile = getString(L, 2);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaNpcTypeRegister(lua_State* L)
{
	// npcType:register()
	NpcType* npcType = getUserdata<NpcType>(L, 1);
	if (npcType) {
		if (npcType->name.empty()) {
			reportErrorFunc("NpcType has no name");
			pushBoolean(L, false);
			return 1;
		}

		// Ensure health values are set properly
		if (npcType->healthMax == 0) {
			npcType->healthMax = npcType->health;
		}
		if (npcType->health == 0) {
			npcType->health = npcType->healthMax;
		}

		npcType->isRegistered = true;
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaNpcTypeOnThink(lua_State* L)
{
	...
	if (npcType) {
		...
		lua_pushvalue(L, 2);
		npcType->thinkCallback = luaL_ref(L, LUA_REGISTRYINDEX);
		npcType->luaState = getScriptEnv()->getScriptInterface();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
int LuaScriptInterface::luaNpcTypeOnAppear(lua_State* L)
{
	...
	if (npcType) {
		...
		lua_pushvalue(L, 2);
		npcType->appearCallback = luaL_ref(L, LUA_REGISTRYINDEX);
		npcType->luaState = getScriptEnv()->getScriptInterface();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaNpcTypeOnDisappear(lua_State* L)
{
	...
	if (npcType) {
		...
		lua_pushvalue(L, 2);
		npcType->disappearCallback = luaL_ref(L, LUA_REGISTRYINDEX);
		npcType->luaState = getScriptEnv()->getScriptInterface();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaNpcTypeOnMove(lua_State* L)
{
	...
	if (npcType) {
		...
		lua_pushvalue(L, 2);
		npcType->moveCallback = luaL_ref(L, LUA_REGISTRYINDEX);
		npcType->luaState = getScriptEnv()->getScriptInterface();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaNpcTypeOnSay(lua_State* L)
{
	...
	if (npcType) {
		...
		lua_pushvalue(L, 2);
		npcType->sayCallback = luaL_ref(L, LUA_REGISTRYINDEX);
		npcType->luaState = getScriptEnv()->getScriptInterface();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaNpcTypeOnCloseChannel(lua_State* L)
{
	...
	if (npcType) {
		...
		lua_pushvalue(L, 2);
		npcType->closeChannelCallback = luaL_ref(L, LUA_REGISTRYINDEX);
		npcType->luaState = getScriptEnv()->getScriptInterface();
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaActionItemId(lua_State* L)
{
	...
	Action* action = getUserdata<Action>(L, 1);
	if (action) {
		int parameters = lua_gettop(L) - 1; // - 1 because self is a parameter aswell, which we want to skip
		if (parameters > 1) {
...
int LuaScriptInterface::luaMoveEventType(lua_State* L)
{
	...
	if (moveevent) {
		...
		if (tmpStr == "stepin") {
			...
			std::cout << "[Warning - MoveEvent::configureMoveEvent] Unknown event type: " << typeName << std::endl;
			pushBoolean(L, false);
			return 1;
		}
		pushBoolean(L, true);
...
int LuaScriptInterface::luaMoveEventItemId(lua_State* L)
{
	...
	if (moveevent) {
		...
		if (parameters > 1) {
			for (int i = 0; i < parameters; ++i) {
				moveevent->setItemIdsVector(getNumber<uint16_t>(L, 2 + i));
			}
		} else {
			moveevent->setItemIdsVector(getNumber<uint16_t>(L, 2));
		}
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaMoveEventActionId(lua_State* L)
{
	...
	if (moveevent) {
		...
		if (parameters > 1) {
			for (int i = 0; i < parameters; ++i) {
				moveevent->setActionIdsVector(getNumber<uint16_t>(L, 2 + i));
			}
		} else {
			moveevent->setActionIdsVector(getNumber<uint16_t>(L, 2));
		}
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaMoveEventUniqueId(lua_State* L)
{
	...
	if (moveevent) {
		...
		if (parameters > 1) {
			for (int i = 0; i < parameters; ++i) {
				moveevent->setUniqueIdsVector(getNumber<uint16_t>(L, 2 + i));
			}
		} else {
			moveevent->setUniqueIdsVector(getNumber<uint16_t>(L, 2));
		}
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaMoveEventPosition(lua_State* L)
{
	...
	if (moveevent) {
		...
		if (parameters > 1) {
			for (int i = 0; i < parameters; ++i) {
				moveevent->setPositionsVector(getPosition(L, 2 + i));
			}
		} else {
			moveevent->setPositionsVector(getPosition(L, 2));
		}
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaTalkActionRegister(lua_State* L)
{
	...
	if (talkAction) {
		...
		pushBoolean(L, g_talkActions->registerLuaEvent(talkAction));
	} else {
		lua_pushnil(L);
	}
	return 1;
...
int LuaScriptInterface::luaTalkActionWords(lua_State* L)
{
	// talkaction:words(words[, separator = "\""])
	TalkAction* talkAction = getUserdata<TalkAction>(L, 1);
	if (talkAction) {
		talkAction->setWords(getString(L, 2));
		if (lua_gettop(L) >= 3) {
			std::string separator = getString(L, 3);
			if (!separator.empty()) {
				talkAction->setSeparator(separator[0]);
			}
		}
		pushBoolean(L, true);
	} else {
...
int LuaScriptInterface::luaTalkActionSeparator(lua_State* L)
{
	...
	TalkAction* talkAction = getUserdata<TalkAction>(L, 1);
	if (talkAction) {
		std::string separator = getString(L, 2);
		if (!separator.empty()) {
			talkAction->setSeparator(separator[0]);
		}
		pushBoolean(L, true);
...
int LuaScriptInterface::luaCreatureEventType(lua_State* L)
{
	...
	if (creatureEvent) {
		...
		if (tmpStr == "login") {
			...
			std::cout << "[Warning - CreatureEvent::configureLuaEvent] Unknown event type: " << typeName << std::endl;
			pushBoolean(L, false);
			return 1;
		}
		pushBoolean(L, true);
...
int LuaScriptInterface::luaGlobalEventType(lua_State* L)
{
	...
	if (globalEvent) {
		...
		if (tmpStr == "timer") {
			...
			std::cout << "[Warning - GlobalEvent::configureLuaEvent] Unknown event type: " << typeName << std::endl;
			pushBoolean(L, false);
			return 1;
		}
		pushBoolean(L, true);
...
// RevScriptSys - MoveEvent additional functions
...
int LuaScriptInterface::luaMoveEventSlot(lua_State* L)
{
	...
	if (moveevent) {
		...
		if (tmpStr == "head") {
			...
			std::cout << "[Warning - MoveEvent::setSlot] Unknown slot: " << slotName << std::endl;
		}
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaMoveEventPremium(lua_State* L)
{
	...
	MoveEvent* moveevent = getUserdata<MoveEvent>(L, 1);
	if (moveevent) {
		moveevent->setRequiresPremium(getBoolean(L, 2));
...
int LuaScriptInterface::luaMoveEventVocation(lua_State* L)
{
	...
	if (moveevent) {
		...
		std::string vocationString = moveevent->getVocationString();
		if (!vocationString.empty()) {
			vocationString += ", ";
		}
		vocationString += getString(L, 2);
		if (lua_gettop(L) >= 3 && getBoolean(L, 3)) {
			vocationString += " (promoted)";
		}
		moveevent->setVocationString(vocationString);
		pushBoolean(L, true);
	} else {
		lua_pushnil(L);
	}
...
// Spell (RevScriptSys)
int LuaScriptInterface::luaCreateSpell(lua_State* L)
{
	// Spell(words) or Spell(SPELL_INSTANT) or Spell(SPELL_RUNE)
	SpellType_t spellType = SPELL_INSTANT;
	if (lua_isnumber(L, 2)) {
		spellType = getNumber<SpellType_t>(L, 2);
	}

	if (spellType == SPELL_INSTANT) {
		InstantSpell* spell = new InstantSpell(&g_luaEnvironment);
		spell->fromLua = true;
		spell->setSpellType(SPELL_INSTANT);
		// Store as Spell* to allow proper casting later
		pushUserdata<Spell>(L, static_cast<Spell*>(spell));
		setMetatable(L, -1, "Spell");
	} else if (spellType == SPELL_RUNE) {
		RuneSpell* spell = new RuneSpell(&g_luaEnvironment);
		spell->fromLua = true;
		spell->setSpellType(SPELL_RUNE);
		// Store as Spell* to allow proper casting later
		pushUserdata<Spell>(L, static_cast<Spell*>(spell));
		setMetatable(L, -1, "Spell");
	} else {
...
int LuaScriptInterface::luaSpellOnCastSpell(lua_State* L)
{
	...
	Spell* spellBase = getUserdata<Spell>(L, 1);
	if (!spellBase) {
		lua_pushnil(L);
		return 1;
	}
	...
	Event* spell = nullptr;
	if (spellBase->getSpellType() == SPELL_INSTANT) {
		spell = dynamic_cast<InstantSpell*>(spellBase);
	} else if (spellBase->getSpellType() == SPELL_RUNE) {
		spell = dynamic_cast<RuneSpell*>(spellBase);
	}
	...
	if (!spell->getScriptInterface()) {
		spell->setScriptInterface(&g_luaEnvironment);
	}
...
{
	// spell:register()
	// Get the spell and check its type
	Spell* spellBase = getUserdata<Spell>(L, 1);
	if (!spellBase) {
		lua_pushnil(L);
		return 1;
	...
	if (spellBase->getSpellType() == SPELL_INSTANT) {
		InstantSpell* instantSpell = dynamic_cast<InstantSpell*>(spellBase);
		if (!instantSpell || !instantSpell->isScripted()) {
			pushBoolean(L, false);
			return 1;
		}
		pushBoolean(L, g_spells->registerLuaEvent(instantSpell));
		return 1;
	}
	
	if (spellBase->getSpellType() == SPELL_RUNE) {
		RuneSpell* runeSpell = dynamic_cast<RuneSpell*>(spellBase);
		if (!runeSpell || !runeSpell->isScripted()) {
			pushBoolean(L, false);
			return 1;
		}
		pushBoolean(L, g_spells->registerRuneLuaEvent(runeSpell));
		return 1;
	}
...
int LuaScriptInterface::luaSpellId(lua_State* L)
{
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			...
			spell->setSpellId(getNumber<uint8_t>(L, 2));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaSpellGroup(lua_State* L)
{
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			...
			spell->setGroup(getNumber<SpellGroup_t>(L, 2));
			if (lua_gettop(L) >= 3) {
				spell->setSecondaryGroup(getNumber<SpellGroup_t>(L, 3));
			}
			pushBoolean(L, true);
		}
	} else {
...
int LuaScriptInterface::luaSpellSecondaryGroup(lua_State* L)
{
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			...
			spell->setSecondaryGroup(getNumber<SpellGroup_t>(L, 2));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// spell:groupCooldown(groupCooldown[, secondaryGroupCooldown])
	Spell* spell = getUserdata<Spell>(L, 1);
	if (spell) {
		if (lua_gettop(L) == 1) {
			...
			if (lua_gettop(L) >= 3) {
				spell->setSecondaryGroupCooldown(getNumber<uint32_t>(L, 3));
			}
			pushBoolean(L, true);
		}
	} else {
...
int LuaScriptInterface::luaSpellSecondaryGroupCooldown(lua_State* L)
{
	// spell:secondaryGroupCooldown(secondaryGroupCooldown)
	Spell* spell = getUserdata<Spell>(L, 1);
	if (spell) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, spell->getSecondaryGroupCooldown());
		} else {
			spell->setSecondaryGroupCooldown(getNumber<uint32_t>(L, 2));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaSpellSoul(lua_State* L)
{
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			...
			spell->setSoul(getNumber<uint32_t>(L, 2));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaSpellNeedLearn(lua_State* L)
{
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			...
			spell->setLearnable(getBoolean(L, 2));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaSpellVocation(lua_State* L)
{
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			...
			// Return vocations - simplified
			pushBoolean(L, true);
		} else {
			int32_t vocId = getNumber<int32_t>(L, 2);
			bool lastVoc = getBoolean(L, 3, false);
			spell->addVocMap(vocId, lastVoc);
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
{
	// spell:words(words[, separator]) - only for InstantSpell
	Spell* spellBase = getUserdata<Spell>(L, 1);
	if (spellBase && spellBase->getSpellType() == SPELL_INSTANT) {
		InstantSpell* spell = dynamic_cast<InstantSpell*>(spellBase);
		if (lua_gettop(L) == 1) {
			pushString(L, spell->getWords());
		} else {
			std::string words = getString(L, 2);
			spell->setWords(words);
			if (lua_gettop(L) >= 3) {
				std::string sep = getString(L, 3);
				if (!sep.empty()) {
					spell->setSeparator(sep[0]);
				}
			}
			pushBoolean(L, true);
		}
...
{
	// spell:needDirection(bool) - only for InstantSpell
	Spell* spellBase = getUserdata<Spell>(L, 1);
	if (spellBase && spellBase->getSpellType() == SPELL_INSTANT) {
		InstantSpell* spell = dynamic_cast<InstantSpell*>(spellBase);
		if (lua_gettop(L) == 1) {
...
{
	// spell:hasParams(bool) - only for InstantSpell
	Spell* spellBase = getUserdata<Spell>(L, 1);
	if (spellBase && spellBase->getSpellType() == SPELL_INSTANT) {
		InstantSpell* spell = dynamic_cast<InstantSpell*>(spellBase);
		if (lua_gettop(L) == 1) {
...
{
	// spell:hasPlayerNameParam(bool) - only for InstantSpell
	Spell* spellBase = getUserdata<Spell>(L, 1);
	if (spellBase && spellBase->getSpellType() == SPELL_INSTANT) {
		InstantSpell* spell = dynamic_cast<InstantSpell*>(spellBase);
		if (lua_gettop(L) == 1) {
...
{
	// spell:blockWalls(bool) - only for InstantSpell
	Spell* spellBase = getUserdata<Spell>(L, 1);
	if (spellBase && spellBase->getSpellType() == SPELL_INSTANT) {
		InstantSpell* spell = dynamic_cast<InstantSpell*>(spellBase);
		if (lua_gettop(L) == 1) {
...
int LuaScriptInterface::luaSpellCharges(lua_State* L)
{
	...
	if (spell) {
		if (lua_gettop(L) == 1) {
			pushBoolean(L, spell->getHasCharges());
		} else {
			spell->setHasCharges(getBoolean(L, 2));
			pushBoolean(L, true);
		}
	} else {
		lua_pushnil(L);
...
int LuaScriptInterface::luaSpellBlockType(lua_State* L)
{
	// spell:blockType(type)
	RuneSpell* spell = dynamic_cast<RuneSpell*>(getUserdata<Spell>(L, 1));
	if (spell) {
		if (lua_gettop(L) == 1) {
			lua_pushnumber(L, spell->getCheckLineOfSight() ? 1 : 0);
		} else {
			std::string blockType = getString(L, 2);
			if (blockType == "solid") {
				spell->setCheckLineOfSight(true);
