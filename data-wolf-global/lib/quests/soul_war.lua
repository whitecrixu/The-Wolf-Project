SoulWarQuest = {
	...
	ebbAndFlow = {
		...
		mapsPath = {
			empty = "data-wolf-global/world/quest/soul_war/ebb_and_flow/ebb-flow-empty.otbm",
			inundate = "data-wolf-global/world/quest/soul_war/ebb_and_flow/ebb-flow-inundate.otbm",
			ebbFlow = "data-wolf-global/world/quest/soul_war/ebb_and_flow/ebb-flow.otbm",
		},
