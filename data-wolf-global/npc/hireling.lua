function createHirelingType(HirelingName)
	...
	-- If it's a Hireling with a name like an npc, example "Hireling Project Wolf", we'll remove the name "Hireling" and keep only the npc name for the look description
