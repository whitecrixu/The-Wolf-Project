...
npcConfig.voices = {
	interval = 15000,
	chance = 20,
		{ text = "Welcome to the Project Wolf Server!" },
}
...
local function greetCallback(npc, creature)
	...
	npcHandler:setMessage(MESSAGE_GREET, "Hello |PLAYERNAME|, you need more info about {project wolf}?")
	return true
end
...
local function creatureSayCallback(npc, creature, type, message)
	...
	if MsgContains(message, "project wolf") then
		npcHandler:say({
			"The goal is for Project Wolf to be an 'engine', that is, it will be \z
