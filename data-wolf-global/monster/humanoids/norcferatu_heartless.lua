...
monster.attacks = {
	...
	-- Clouds Chain
	{ name = "clouds chain", interval = 2000, chance = 8, minDamage = -100, maxDamage = -380, effect = false, target = true },

	-- Whirlwind Axe
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -270, maxDamage = -550, range = 5, shootEffect = CONST_ANI_WHIRLWINDAXE, effect = false, target = true },
