...
LeverUnique = {
	...
	-- Path: data-wolf-global\scripts\actions\quests\desert_dungeon_quest\desert_dungeon_lever.lua
	[30030] = {
		itemId = 2772,
		itemPos = { x = 32673, y = 32086, z = 8 },
	},
	-- Path: data-wolf-global/scripts/actions/quests/the_outlaw_camp/oven.lua
	[30031] = {
		itemId = 2772,
		itemPos = { x = 32614, y = 32173, z = 9 },
	},
	-- Path: data-wolf-global/scripts/actions/quests/the_outlaw_camp/power_switch.lua
	[30032] = {
		itemId = 2772,
		itemPos = { x = 32594, y = 32212, z = 9 },
	},
	-- Path: data-wolf-global/scripts/actions/quests/the_outlaw_camp/power_burn.lua
	[30033] = {
		itemId = 2772,
		itemPos = { x = 32616, y = 32222, z = 10 },
	},
	-- Path: data-wolf-global/scripts/actions/quests/others/triangle_tower_lever.lua
	[30034] = {
		itemId = 2772,
