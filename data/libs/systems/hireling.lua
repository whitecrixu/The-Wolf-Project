...
function SaveHirelings()
	...
	for _, hireling in ipairs(HIRELINGS) do
		...
		if not success then
			...
			print("  - [WARNING] Failed to save hireling: " .. hireling:getName() .. " (ID: " .. hireling:getId() .. ")")
		else
	...
	if successCount == #HIRELINGS then
		print("  - All hirelings successfully saved.")
	else
		print("  - [WARNING] Failed to save " .. failedCount .. " hirelings.")
	end
end
