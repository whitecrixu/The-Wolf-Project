-- Player Death Event (RevScriptSys)
...
local function playerDeathCallback(player, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)
...
playerDeath:type("death")
playerDeath:onDeath(playerDeathCallback)
