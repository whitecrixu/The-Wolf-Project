...
npcType:parameter("message_greet", "|PLAYERNAME|, ARE YOU PREPARED TO FACE YOUR DESTINY?")
npcType:parameter("message_walkaway", "COME BACK WHEN YOU ARE PREPARED TO FACE YOUR DESTINY!")
npcType:parameter("message_farewell", "COME BACK WHEN YOU ARE PREPARED TO FACE YOUR DESTINY!")
