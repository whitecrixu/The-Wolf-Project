...
local monster = Game.createMonsterType("Plaguethrower")
if not monster then return end

monster:name("Plaguethrower")
monster:nameDescription("a plaguethrower")
monster:health(9950)
...
--[[
-- name=earth, interval=2000, chance=100, range=7, max=-100, shootEffect=poison
--]]
