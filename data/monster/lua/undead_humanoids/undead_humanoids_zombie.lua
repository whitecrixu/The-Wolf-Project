...
monster:attacks({
    ...
    {name = "manadrain", interval = 2000, chance = 10, minDamage = -14, maxDamage = -23},
    {name = "lifedrain", interval = 2000, chance = 15, minDamage = -15, maxDamage = -24, range = 7},
    {name = "death", interval = 2000, chance = 15, minDamage = -30, maxDamage = -49}
})
