...
monster:attacks({
    ...
    {name = "energy", interval = 2000, chance = 14, minDamage = -150, maxDamage = -200, length = 4},
    {name = "physical", interval = 2000, chance = 11, maxDamage = -135, range = 7},
    {name = "lifedrain", interval = 2000, chance = 15, minDamage = -50, maxDamage = -150, radius = 3},
