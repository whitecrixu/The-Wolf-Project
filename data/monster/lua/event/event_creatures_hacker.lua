...
--[[
-- name=melee, interval=1000, chance=100, skill=20, attack=55
--]]

-- Defense spells (for reference, implement with spell system)
--[[
-- name=speed, interval=1000, chance=15, duration=6000, speedchange=290, areaEffect=redshimmer
-- name=outfit, interval=10000, chance=15, duration=500, areaEffect=redshimmer
--]]
