...
monster:attacks({
    ...
    {name = "lifedrain", interval = 3000, chance = 7, minDamage = -55, maxDamage = -550},
    {name = "speed", interval = 1000, chance = 25, range = 7},
    {name = "physical", interval = 1000, chance = 20, minDamage = -40, maxDamage = -400, radius = 3},
    {name = "physical", interval = 3000, chance = 7, minDamage = -50, maxDamage = -500, radius = 3}
})
