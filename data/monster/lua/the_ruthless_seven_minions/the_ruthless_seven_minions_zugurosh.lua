...
monster:attacks({
    ...
    {name = "lifedrain", interval = 2000, chance = 10, maxDamage = -500, range = 4},
    {name = "death", interval = 2000, chance = 15, maxDamage = -500, length = 7},
    {name = "death", interval = 2000, chance = 15, maxDamage = -100, radius = 4},
    {name = "firecondition", interval = 3000, chance = 20, minDamage = -10, maxDamage = -10, radius = 4},
    {name = "manadrain", interval = 1000, chance = 13, minDamage = -60, maxDamage = -200, radius = 5}
})
