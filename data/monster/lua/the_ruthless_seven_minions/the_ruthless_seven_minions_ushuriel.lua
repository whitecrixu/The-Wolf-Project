...
monster:attacks({
    ...
    {name = "physical", interval = 1000, chance = 10, minDamage = -250, maxDamage = -500, length = 10},
    {name = "ice", interval = 2000, chance = 10, maxDamage = -400, length = 8, spread = 3},
    {name = "cursecondition", interval = 2000, chance = 15, maxDamage = -800, radius = 4},
    {name = "energycondition", interval = 2000, chance = 15, minDamage = -25, maxDamage = -25, radius = 4},
    {name = "drunk", interval = 3000, chance = 11, radius = 6},
    {name = "earth", interval = 2000, chance = 9, maxDamage = -600, length = 8, spread = 3}
})
