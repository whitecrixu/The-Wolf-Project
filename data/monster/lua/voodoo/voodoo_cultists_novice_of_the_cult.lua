...
--[[
-- name=melee, interval=2000, chance=100, max=-65
-- name=lifedrain, interval=2000, chance=15, range=7, min=-20, max=-80, radius=1, target=1, shootEffect=poison, areaEffect=redshimmer
--]]

-- Defense spells (for reference, implement with spell system)
--[[
-- name=healing, interval=2000, chance=15, min=20, max=40, areaEffect=blueshimmer
--]]
