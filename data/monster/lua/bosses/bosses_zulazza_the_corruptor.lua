...
monster:attacks({
    ...
    {name = "physical", interval = 2000, chance = 40, minDamage = -500, maxDamage = -800, length = 8},
    {name = "poison", interval = 2000, chance = 30, minDamage = -300, maxDamage = -800, radius = 3},
    {name = "manadrain", interval = 2000, chance = 25, minDamage = -50, maxDamage = -130, range = 7},
