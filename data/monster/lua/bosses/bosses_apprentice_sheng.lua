...
monster:attacks({
    ...
    {name = "energy", interval = 1000, chance = 14, minDamage = -15, maxDamage = -25, range = 7},
    {name = "fire", interval = 2000, chance = 10, minDamage = -15, maxDamage = -45, range = 7, radius = 1},
    {name = "energyfield", interval = 1000, chance = 8, range = 7, radius = 1},
    {name = "physical", interval = 10500, chance = 100, radius = 3}
})
