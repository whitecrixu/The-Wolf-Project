...
-- name=physical, interval=2000, chance=40, min=-38, max=-150, shootEffect=throwingknife
--]]

-- Defense spells (for reference, implement with spell system)
--[[
-- name=healing, interval=1000, chance=50, min=75, max=125, areaEffect=blueshimmer
--]]
