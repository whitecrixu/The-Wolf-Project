...
-- name=energy, interval=2000, chance=12, min=-250, max=-820, length=8, areaEffect=purpleenergy
-- name=manadrain, interval=2000, chance=9, min=-90, max=-500, radius=5, areaEffect=stun
-- name=manadrain, interval=2000, chance=11, range=7, min=-250, max=-420, target=1, shootEffect=energyball, areaEffect=teleport
-- name=energy, interval=2000, chance=8, range=7, min=-200, max=-400, target=1, shootEffect=energy, areaEffect=purpleenergy
-- name=fire, interval=2000, chance=15, range=7, min=-120, max=-570, radius=4, target=1, shootEffect=fire, areaEffect=firearea
-- name=hellgorak skill reducer, interval=2000, chance=11
--]]

-- Defense spells (for reference, implement with spell system)
--[[
-- name=healing, interval=2000, chance=27, min=350, max=470, areaEffect=blueshimmer
-- name=healing, interval=2000, chance=8, min=1450, max=1700, areaEffect=yellowenergy
-- name=speed, interval=2000, chance=12, duration=6000, speedchange=542, areaEffect=redshimmer
--]]
