...
--[[
-- name=melee, interval=2000, chance=100, skill=185, attack=175
-- name=death, interval=1000, chance=11, max=-600, length=8, areaEffect=mortarea
-- name=death, interval=2000, chance=15, min=-200, max=-700, radius=4, areaEffect=icearea
-- name=physical, interval=3000, chance=18, min=-50, max=-255, radius=5, target=1, areaEffect=groundshaker
-- name=fire, interval=2000, chance=15, min=-50, max=-600, radius=6, target=1, areaEffect=firearea, shootEffect=fire
--]]

-- Defense spells (for reference, implement with spell system)
--[[
-- name=healing, interval=1000, chance=14, min=400, max=900, areaEffect=greenshimmer
-- name=speed, interval=1000, chance=4, duration=7000, speedchange=500, areaEffect=blueshimmer
--]]
