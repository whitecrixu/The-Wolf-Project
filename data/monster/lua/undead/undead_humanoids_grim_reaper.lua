...
--[[
-- name=melee, interval=2000, chance=100, max=-320
-- name=physical, interval=2000, chance=20, range=7, max=-165, shootEffect=suddendeath, areaEffect=mortarea
-- name=death, interval=2000, chance=10, min=-350, max=-720, length=8, areaEffect=redspark
-- name=physical, interval=2000, chance=15, max=-300, length=7, spread=3, areaEffect=explosionarea
-- name=death, interval=2000, chance=10, min=-225, max=-275, radius=4, areaEffect=redspark
--]]

-- Defense spells (for reference, implement with spell system)
--[[
-- name=healing, interval=2000, chance=15, min=130, max=205, areaEffect=redspark
