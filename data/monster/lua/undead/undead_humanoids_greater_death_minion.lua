...
local monster = Game.createMonsterType("Greater Death Minion")
if not monster then return end

monster:name("Greater Death Minion")
monster:nameDescription("a greater death minion")
monster:health(240)
...
--[[
-- name=melee, interval=2000, chance=100, max=-85
-- name=death, interval=2000, chance=20, range=1, min=-30, max=-40, target=1, shootEffect=death, areaEffect=smallclouds
-- name=speed, interval=2000, chance=15, range=7, target=1, duration=10000, speedchange=-226, areaEffect=redshimmer
--]]
