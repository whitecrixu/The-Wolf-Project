...
-- name=lifedrain, interval=2000, chance=10, range=1, min=-15, max=-27, radius=1, target=1, areaEffect=smallclouds
--]]

-- Defense spells (for reference, implement with spell system)
--[[
-- name=healing, interval=2000, chance=5, min=9, max=15, areaEffect=blueshimmer
--]]
