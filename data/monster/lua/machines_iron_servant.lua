...
-- name=physical, interval=2000, chance=15, range=7, max=-60, shootEffect=smallstone, areaEffect=explosionarea
-- name=drunk, interval=2000, chance=10, range=7, target=1, duration=2000, shootEffect=explosion, areaEffect=stun
--]]
