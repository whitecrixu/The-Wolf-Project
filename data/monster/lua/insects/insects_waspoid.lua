...
--[[
-- name=melee, interval=2000, chance=100, skill=80, attack=55
-- name=earth, interval=2000, chance=15, min=-110, max=-180, radius=3, target=1, areaEffect=poison
-- name=earth, interval=2000, chance=15, range=7, min=-80, max=-100, shootEffect=poison
--]]
