...
-- name=earth, interval=1000, chance=10, max=-800, length=7, areaEffect=stones
-- name=earth, interval=1000, chance=9, max=-490, radius=6, areaEffect=bigplants
-- name=speed, interval=2000, chance=20, range=7, duration=4000, speedchange=-750, areaEffect=redshimmer
--]]
