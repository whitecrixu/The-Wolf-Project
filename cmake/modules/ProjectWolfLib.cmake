# Define and setup Wolf main library target
...
target_sources(${PROJECT_NAME}_lib PRIVATE wolf_server.cpp)
...
if(FEATURE_METRICS)
    ...
    target_link_libraries(${PROJECT_NAME}_lib
            ...
            opentelemetry-cpp::exporter_trace_otlp_http
            opentelemetry-cpp::exporter_logs_otlp_http
            opentelemetry-cpp::exporter_metrics_otlp_http
    )
endif()

if(USE_MYSQL_ENGINE)
    add_definitions(-DUSE_MYSQL_ENGINE)
    target_link_libraries(${PROJECT_NAME}_lib PUBLIC MySQL::MySQL)
endif()

if(USE_STATIC_LIBS)
    log_option_enabled("Using static libraries")
endif()
