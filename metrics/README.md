# The Wolf Project Metrics (OpenTelemetry)
...
The easiest, batteries included way, to do this is using the provided `docker-compose.yml` file provided in this `metrics` directory. Simply run `docker-compose up` and you will have a Prometheus instance running and scraping the Wolf Project metrics endpoint.
...
**Screenshot**
![grafana](https://wolf-project.org/assets/223760/b307c335-9af9-4c1a-bf7e-5c3dc86a016d)
...
**Raw exp/h**
![exp-per-hour](https://wolf-project.org/assets/223760/3a873aca-f2e4-4d19-8e61-ed20c176a30f)

**Raw gold/h**
![gold-per-hour](https://wolf-project.org/assets/223760/1c0d1e99-c4b9-4d9a-aced-75ac376b4673)

**Monsters killed/h**
![monsters-per-hour](https://wolf-project.org/assets/223760/4d8c9e19-d579-4405-a018-fc69c79a11c2)
